...
const NavLogo = () => {
  ...
  return (
    <div className="nav-center row">
      <div className="nav-center__logo col c-3">
        <Link to="/">
          <svg
            version="1.1"
            x="0px"
      ...
      <div className="nav-center__search col c-5">
      ...
      <div className="nav-center__func col c-4">
        <ul className="list-inline func-icons">
          <li className="func-item">
            <RepeatIcon fontSize="large" />
            <span className="count-circle-abs">0</span>
          </li>
          <li className="func-item">
