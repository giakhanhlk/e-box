  ...
  return (
    <div className="login-page">
          ...
          <div className="container wide">
            <div className="navbar row">
              <div className="navbar__logo col l-4">
                ...
                <span className="navbar__title">Đăng nhập</span>
              </div>
      ...
      <main className="login__content">
        <div className="login__frame container wide">
          <div className="row">
            <div className="left__content col l-6 m-12 c-12">
              <div className="left__content-title">Đăng nhập</div>
              <div className="left__content-description">
                Vui lòng đăng nhập để mua hàng
              </div>
              <div className="left__content-google-login">
                <img
                  height="25"
                  width="25"
                  src="https://img.icons8.com/cute-clipart/64/000000/google-logo.png"
                />
                <span className="google-login__text">
                    ...
                    <div className="support-left-side">
                      <label htmlFor="remember">
                        <input
                          ...
                          value="remember"
                        />
                        <span style={{ marginLeft: "5px" }}>Nhớ tài khoản</span>
                      </label>
                    </div>
            ...
            <div className="login__content-right col l-6 m-0 c-0">
