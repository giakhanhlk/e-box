...
const RegisterPage = () => {
  ...
  const registration = useSelector((state) => state.reg);
  ...
  return (
    <div className="register-page">
        ...
        <nav className="register__nav">
          <div className="container wide">
            <div className="navbar row">
              <div className="navbar__logo col l-4">
                <svg
                  version="1.1"
                  x="0px"
                  y="0px"
                ...
                <span className="navbar__title">Đăng ký</span>
              </div>
              <div className="navbar__right col l-4">
      ...
      <main className="register__content">
        <div className="register__frame container wide">
          <div className="row">
            <div className="left__content col l-6 m-12 c-12">
              <div className="left__content-title">Đăng ký</div>
              <div className="left__content-description">
                Vui lòng đăng ký để mua hàng
              </div>
              <div className="left__content-google-register">
                <img
                  height="25"
                  width="25"
                  src="https://img.icons8.com/cute-clipart/64/000000/google-logo.png"
                />
                <span className="google-register__text">
                  Đăng nhập bằng Google
                </span>
              </div>
              <div className="left__content-form">
                <form
                ...
                >
                  ...
                  <div className="left__content-support">
                    <div className="support-left-side">
                      <label htmlFor="remember">
                        ...
                        <span style={{ marginLeft: "5px" }}>
                          Tôi đồng ý với{" "}
                          <Link to="/term-and-support">các điều khoản</Link>
                        </span>
                      </label>
                    </div>
                  </div>
                  <button
                    ...
                    type="submit"
                    disabled={registration.loading ? true : false}
                  >
              ...
              <div className="left__content-redirect-register">
                Đã có tài khoản?{" "}
                <span>
            ...
            <div className="register__content-right col l-6 m-0 c-0">
              <div className="right__content-image">
                <img
                  height="600"
                  width="550"
