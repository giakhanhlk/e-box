...
const Footer = () => {
  return (
    <footer>
      <PartnersSlide slides={slides} />
      <div className="footer-info section-mg">
        <div className="footer-inner container wide">
          <div className="row">
            <div className="footer-info__contact col l-4">
              ...
              <div className="contact-phone">
                ...
                <div className="phone-holder">
                  <div className="phone-description">
                    Bạn có thắc mắc? Hãy liên hệ với chúng tôi!
                  </div>
                  <div className="phone-number">(+84) 903046492</div>
                </div>
              </div>
              <div className="contact-address">
                <span className="text-bold">Địa chỉ văn phòng: </span>
                11 Công xa Paris, Bến Nghé, Quận 1, TP. Hồ Chí Minh
              </div>
            </div>
            <div className="footer-info__link col l-2">
              <div className="link-title">Hỗ trợ khách</div>
              <div className="link-section-1">
                <ul className="list-column">
                  <li className="linker">Các câu hỏi thường gặp</li>
                  <li className="linker">Hướng dẫn đặt hàng</li>
                  <li className="linker">Phương thức vận chuyển</li>
                  <li className="linker">Hướng dẫn trả góp</li>
                  <li className="linker">Chính sách hàng nhập khẩu</li>
                </ul>
              </div>
            </div>
            <div className="link-holder-1 col l-2">
              <div className="link-title">Về Box</div>
              <div className="link-section-1">
                <ul className="list-column">
                  <li className="linker">Giới thiệu về Box</li>
                  <li className="linker">Tuyển dụng</li>
                  <li className="linker">Chính Sách bảo mật thanh toán</li>
                  <li className="linker">Chính sách giải quyết khiếu nại</li>
                  <li className="linker">Điều khoản sử dụng</li>
                  <li className="linker">Bán hàng doanh nghiệp</li>
                </ul>
              </div>
            </div>
            <div className="link-holder-1 col l-2">
              <div className="link-title">Hỗ trợ và liên kết</div>
              <div className="link-section-1">
                <ul className="list-column">
                  <li className="linker">Quy chế hoạt động Sàn GDTMĐT</li>
                  <li className="linker">Bán cùng Box</li>
                </ul>
              </div>
            </div>
            <div className="link-holder-1 col l-2">
              ...
              <div className="download-app">
                <div className="title">Tải ứng dụng trên điện thoại</div>
                <div className="section-link-3">
        ...
        <div className="container wide">
          <div className="content-inline">
            <div className="copyright">
              © 2021 <span style={{ fontWeight: "bolder" }}>Electro</span>. All
              Rights Reserved
            </div>
            <div className="payment-icons">
              <img
                src="https://cdn.shopify.com/s/files/1/0066/4322/0562/files/patment-icon-648x76_648x_85159418-2dd1-46fe-988c-39c81f26ab1a_324x.png?v=1604560580"
                alt="payments-logo"
              />
            </div>
          </div>
